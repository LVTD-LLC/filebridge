...
- AI data collection
- reviewable AI data collection workflow
- collection control plane for agents
- source registry and capture runs
- reviewable agent-collected records
- MCP OAuth vs API keys
- MCP authorization decision guide
