...
| 11 | Build the off-page starter target list and submission backlog | Off-page | completed | `scribe/seo-phase-11-backlink-research-20260727` (PR TBD) |
...
**Completed 2026-07-27:** built a source-verified backlog of 16 qualified targets
across the official MCP Registry, active MCP directories, a 91,000-star community
list, open-source and software directories, launch surfaces, and current database
MCP roundups. Each target records live requirements, cost/link caveats, the Rowset
page to promote, status, and a concrete next action. The backlog also excludes
read-only aggregators, a reference-only repository, weak/spammy directories, and
premature review profiles. No listing, upstream pull request, outreach message, or
paid submission was sent.
